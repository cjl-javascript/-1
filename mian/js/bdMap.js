...
function ShowMap(objname,options){
	if(options){
		...
		this._zoom = options.zoom ? options.zoom : "20"; //放大级别，默认14
	}
	//设定初始坐标
	...
	if (this._ismove=="0"){
		...
		//显示窗口设置
		var opts = {width:300,height:100,title : "<font color=green size=3>" + this._title + "</font>"} //窗口标题
		...
		infotxt += "</td><td><p style='font-size:12px;line-height:16px;padding-top:0px;'>";
	
		if (this._addr !=""){infotxt += "<b style='width:100px;'>地址：</b>" + this._addr + "<br/>";};
